...
void error() {
    ...
    cout << " (example: 5 = 5x5 grid, minimum 4)" << endl;
    cout << "Second argument is debug/cheat mode, either true or false."
         << endl;
}
...
void gameInstructions(string debug) {
    ...
    cout << endl;
    cout << "You can move or fire an arrow North, South, East, or West."
         << endl;
    ...
    cout << "to win." << endl;
    cout
        << "Watch out though, if you enter it's room, the Wumpus will eat you.";
    cout << endl << endl;
    if (debug == "true") debug_instructions();
    cout << endl << "Ready to play?" << endl;
    cout << "Your player will be represented with a \"*\". Press enter to "
            "play: ";
    cout << endl;
}
